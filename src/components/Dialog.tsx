    ...
    <HeadlessTransition appear show={open} {...props}>
      <HeadlessDialog onClose={onClose}>
        <HeadlessTransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 z-[1] flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50" />
        </HeadlessTransitionChild>

        <div className="fixed inset-0 z-[2] w-screen overflow-y-auto pt-6 sm:pt-0">
...
export function DialogActions({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        "flex flex-col-reverse items-center justify-end gap-3 pt-8 *:w-full sm:flex-row sm:*:w-auto"
      )}
    />
  );
}
